...
/// Definition of a skill category (e.g. CBT, ACT, mindfulness).
class SkillCategory {
  final String id;
  final String name;
  final IconData icon;
...
/// All category definitions used in the skills lab.
const skillCategories = <SkillCategory>[
  ...
  SkillCategory(
      ...
      icon: Icons.explore,
      emoji: '🌿'),
  SkillCategory(id: 'motivation', name: '动机增强', icon: Icons.bolt, emoji: '💪'),
  SkillCategory(
      id: 'health',
      name: '健康教育',
...
/// Data model for a single exercise in the skills lab.
class ExerciseData {
  final IconData icon;
  final String title;
...
/// The complete library of 30 exercises.
