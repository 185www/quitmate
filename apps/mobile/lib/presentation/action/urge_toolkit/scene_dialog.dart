...
class _SceneCaptureDialogState extends ConsumerState<SceneCaptureDialog> {
  ...
  static const _activities = ['工作/学习', '放松/休息', '吃饭/喝水', '喝酒/派对', '压力/焦虑', '无聊/空闲', '熬夜/失眠', '其他'];
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Text('记录当时场景', style: Theme.of(context).textTheme.titleMedium?.copyWith(fontWeight: FontWeight.w600)),
          const SizedBox(height: 4),
          Text('了解触发场景有助于预防复发', style: Theme.of(context).textTheme.bodySmall?.copyWith(color: Theme.of(context).colorScheme.onSurfaceVariant)),
          const SizedBox(height: 20),
          ...
          Wrap(
            spacing: 8,
            runSpacing: 4,
            children: _socials.map((s) => ChoiceChip(
              label: Text(s),
              selected: _social == s,
