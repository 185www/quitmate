...
class User {
  ...
  bool get isReadyForAction =>
      stage == UserStage.preparation || stage == UserStage.action;
  ...
  double get dailyCost {
    ...
    double cost = 0;
    if (targetType != TargetType.alcohol)
      cost += estimatedDailyCigarettes * 0.5;
